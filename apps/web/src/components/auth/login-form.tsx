  ...
  if (status.kind === "sent") {
    return (
      <div role="status" aria-live="polite" className="rise">
        <p className="label text-traced">Link sent</p>
        ...
        <button
          ...
          className="mt-6 rounded-xs text-[0.875rem] text-ink underline decoration-rule-strong underline-offset-4 hover:decoration-stamp"
        >
  ...
  return (
    <div>
      <Button
        ...
        variant="outline"
        size="lg"
        className="w-full gap-2.5 rounded-xs border-rule-strong bg-paper-raised py-5 text-[0.9375rem] text-ink hover:bg-paper-sunk"
      >
        <GoogleMark />
      ...
      <form onSubmit={sendLink} noValidate>
        ...
        <Input
          ...
          className="mt-2 h-11 rounded-xs border-rule-strong bg-paper-raised px-3 text-[0.9375rem] text-ink placeholder:text-ink-faint"
        />
        ...
        <Button
          ...
          size="lg"
          disabled={busy}
          className="mt-3 w-full rounded-xs bg-stamp py-5 text-[0.9375rem] text-paper-raised hover:bg-stamp/90"
        >
      ...
      <div aria-live="polite" className="min-h-[3rem] pt-3">
        {status.kind === "failed" ? (
          <p
            id="login-error"
            className="rounded-xs border-l-2 border-stamp bg-stamp-soft/60 px-3 py-2 text-[0.8125rem] leading-relaxed text-ink"
          >
            <span className="font-medium text-stamp">{status.reason}</span>{" "}
            {status.remedy}
          </p>
        ) : (
          <p id="login-hint" className="text-[0.8125rem] leading-relaxed text-ink-faint">
